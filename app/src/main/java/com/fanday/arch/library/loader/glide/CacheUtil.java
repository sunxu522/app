...
public class CacheUtil {
    ...
    public String getCacheSize() {
        try {
            return getFormatSize(getFolderSize(new File(App.getInstance().getCacheDir() + "/" + GlideCache.GLIDE_CARCH_DIR)));
    ...
    public boolean cleanCacheDisk() {
        return deleteFolderFile(App.getInstance().getCacheDir() + "/" + GlideCache.GLIDE_CARCH_DIR, true);
    }
